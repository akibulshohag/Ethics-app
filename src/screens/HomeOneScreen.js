    ...
    <View style={styles.landingContainer}>
      <SafeAreaView style={styles.centerContent}>
        ...
        >
          ...
          <Text style={styles.landingSearchPlaceholder}>
            Search Your address
          </Text>
        </TouchableOpacity>
    ...
    <View style={styles.mainContainer}>
      <View style={styles.header}>
        ...
        <Text style={styles.resultsTitle}>
          Your search results in Manchester...
        </Text>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.locationSection}>
          ...
          <Text style={styles.addressSubtext}>
            Ground floor, p17/7 park street, s ...
          </Text>
      ...
      <SafeAreaView style={styles.videoOverlay}>
        ...
        <View style={styles.videoFooter}>
          <Text style={styles.videoUser}>
            @{selectedItem?.title.toLowerCase().replace(' ', '')}
          </Text>
                ...
                openRestaurantDetail(
                  selectedItem
                    ? {
                        ...
                        location: selectedItem.location || 'Birmingham, UK',
